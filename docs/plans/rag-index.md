...
| 분류 | 파일 | 정책 |
|------|------|------|
| **Do Not Touch** | `src/llm/ollama-client.ts`, `src/llm/ndjson.ts`, `src/llm/errors.ts`, `docs/design/**`, `docs/plans/core-engine-*.md`, `docs/plans/memory-*.md` | 기존 LLM 코어와 landing된 계획 문서 무변경 |
